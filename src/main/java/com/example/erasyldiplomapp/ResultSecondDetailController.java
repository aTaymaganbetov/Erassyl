...
public class ResultSecondDetailController extends WindowFunctionality implements Initializable {
    ...
    String SELECT_ALL_FROM_RESULT = "SELECT * FROM result_2";
    ...
    public void exportAction() throws FileNotFoundException {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Admin\\Desktop\\export_result2.txt"))) {
