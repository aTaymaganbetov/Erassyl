...
public class Test2_1Controller extends WindowFunctionality implements Initializable {
    ...
    Answers2_1 instance = Answers2_1.getInstance();

    @FXML
    void instructionAction() {
        openWindowWithStage("instruction2_1.fxml", 900, 600, StageInstance.getInstance().stage);
    }
    ...
    void nextAction() {
        try {
            ...
            openWindowWithStage("result2_1.fxml", 900, 600, StageInstance.getInstance().stage);
